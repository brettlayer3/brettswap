          ...
          <>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="hidden sm:block sm:ml-4">
                    <div className="flex space-x-2">
                      ...
                      <NavLink href="https://analytics.brettswap.com">
                        <a
                          target="_blank"
                          id={`swap-nav-link`}
                          className="p-2 text-base text-primary hover:text-high-emphesis focus:text-high-emphesis whitespace-nowrap"
                ...
                <div className="flex flex-1 -mr-2 sm:hidden">
                  <div className="flex-1">
                    <Image src="/icon.png" alt="Brettswap" height="40px" width="40px" className="sm:hidden" />
                  </div>
                  <LanguageSwitch />
            ...
            <Popover.Panel className="sm:hidden header-border-b">
              <div className="flex flex-col px-4 pt-2 pb-3 space-y-1">
                ...
                <Link href="https://analytics.brettswap.com">
                  <a
                    target="_blank"
                    className="p-2 text-baseline text-primary hover:text-high-emphesis focus:text-high-emphesis md:p-3 whitespace-nowrap"
                  >
