...
export const LOCKER_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0xA9Ead5d7C9D0B59A2900824A125F3913009fD638',
}

export const BSWAP_DISTRIBUTOR_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0xf03b75831397D4695a6b9dDdEEA0E578faa30907',
}

export const BSWAP_VAULT_ADDRESS: AddressMap = {
  [ChainId.BRETTVM_SEPOLIA]: '0x7e6E03822D0077F3C417D33caeAc900Fc2645679',
}

export const BSWAP_BRETT_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0x7eDA899b3522683636746a2f3a7814e6fFca75e1',
}

export const BRETT_USDC_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0xe537f70a8b62204832B8Ba91940B77d3f79AEb81',
}

export const RIB_BRETT_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0x0acDB54E610dAbC82b8FA454b21AD425ae460DF9',
}
...
export const MULTICALL2_ADDRESS: AddressMap = {
  ...
  [ChainId.BRETTVM_SEPOLIA]: '0x5017EF877cD9dd192883B2426d2eBD5a535aAA64',
...
export const WETH9: AddressMap = {
  ...
  [ChainId.BSC_TESTNET]: '',
  [ChainId.MOONBEAM_TESTNET]: '',
  [ChainId.BRETTVM_SEPOLIA]: '0x22F67144992619098F376A7a0d270Aab7fDdA885',
  [ChainId.AVALANCHE]: '',
  [ChainId.AVALANCHE_TESTNET]: '',
  [ChainId.HECO]: '',
  [ChainId.HECO_TESTNET]: '',
