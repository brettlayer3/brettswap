...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Add Liquidity`)} | Brettswap</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the Brettswap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
      <BrettswapLogo />
