...
export default function CreateLocker(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Locker | Brettswap</title>
        <meta key="description" name="description" content="Brettswap Locker" />
      </Head>
              ...
              <Card className="h-full bg-dark-900 z-4">
                <div className={`grid grid-cols-12 gap-4`}>
                  ...
                  <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                    ...
                    <div className="mb-4 text-base text-secondary">
                      <p>{i18n._(t`- 0.1 BRETT to lock`)}</p>
                    </div>
                    ...
                    <div className="mb-4 text-base text-secondary">
                      ...
                      <p>{i18n._(t`- Locker contract address: ${LOCKER_ADDRESS[chainId || 532]}`)}</p>
